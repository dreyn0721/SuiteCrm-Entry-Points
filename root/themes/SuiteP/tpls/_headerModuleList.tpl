    ...
    <div class="container-fluid">
        ...
        <div class="mobile-bar">
            <ul id="toolbar" class="toolbar">
                ...
                <li class="main-cus custom-ringba-act-container" style="display: none;"> <!-- Display none on load -->
                    <span class="text-white time-status">00:00:00</span>
                    <a href="#" class="ringba-act-btn onpaused" data-current_user_id="{$CURRENT_USER_ID}">Pause</a>
                </li>
        ...
        <div class="tablet-bar">
            <ul id="toolbar" class="toolbar">
                ...
                <li class="custom-ringba-act-container" style="display: none;"> <!-- Display none on load -->
                    <span class="text-white time-status">00:00:00</span>
                    <a href="#" class="ringba-act-btn onpaused" data-current_user_id="{$CURRENT_USER_ID}">Pause</a>
                </li>
