...
<head>
    ...
    <link href="custom/themes/customTheme/css/customStyle.css" rel="stylesheet" type="text/css"/>
    ...
    <script type="text/javascript" src='{sugar_getjspath file="custom/themes/customTheme/js/custom.js"}'></script>
</head>
