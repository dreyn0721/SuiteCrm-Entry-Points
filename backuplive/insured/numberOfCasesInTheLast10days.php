...
while ($row = $insured->db->fetchByAssoc($result)) {
    ...
    if( isset( $formula ) && ( isset( $row['numberofcasesinthelast10days_c'] ) || is_null( $row['numberofcasesinthelast10days_c'] ) ) && ( isset( $row['id_c'] ) && $row['id_c'] ) ){ //zxc
